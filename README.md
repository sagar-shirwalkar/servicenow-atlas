...
| **Chunk metadata store** | `pyarrow` Parquet (snappy compressed) | Direct pyarrow+numpy, no pandas. Columnar, compressed, zero-copy reads. Every MCP tool call shaves ~300 ms of pandas import time. |
